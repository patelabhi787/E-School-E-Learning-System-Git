...
<head>
  <meta charset="utf-8">
  <title>Eschool - The Perfect Educator</title>
...
<body>
  <div id="wrapper">
    <header>
      <!-- Navbar
    ================================================== -->
      <div class="navbar navbar-static-top" id="xyz">
        <div class="navbar-inner" id="xyz">
          <div class="container">
            <!-- logo -->
            <div class="logo">
              <a href="index.php"><img src="images/eschool.png" width="150" height="150" alt="" /></a>
            </div>
            <!-- end logo -->
            ...
            <div class="navigation">
              <nav>
                <ul class="nav topnav">
                  ...
                  <li>
                    <a href="<?php echo web_root; ?>index.php?q=lesson"><i class="icon-list-alt"></i> Courses</a>
                  </li>
                  <li>
                    <a href="<?php echo web_root; ?>index.php?q=exercises"><i class="icon-list-alt"></i> Assignments</a>
                  </li>
                  <li>
