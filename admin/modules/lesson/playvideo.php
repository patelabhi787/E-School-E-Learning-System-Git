 ...
 <div class="container" >
 	<video width="50%"  controls>
        ...
        <div class="col-lg-12"><b>Description</b></div>
         <div class="col-lg-12">
           <label class="col-md-2" class="control-label"><b>Chapter :- </b> <?php echo $res->LessonChapter; ?></label>
<!--            <label class="col-md-10" class="control-label"><?php echo $res->LessonChapter; ?></label> -->
         </div>
         <div class="col-lg-12">
           <label class="col-md-2" class="control-label"><b>Title :- </b> <?php echo $res->LessonTitle; ?></label>
