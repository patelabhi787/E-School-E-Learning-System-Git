...
<head>
    <head>
        ...
        <title>ESchool-Adminstrator</title>
    ...
    <body>
            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index.php"><img src="<?php echo web_root; ?>images/eschool.png" width="130" height="120" alt="logo" /></a>
                        ...
                        <ul class="nav pull-right">
                            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Add
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="<?php echo web_root;?>admin/modules/exercises/index.php?view=add">Assignment</a></li>
                                    <li><a href="<?php echo web_root;?>admin/modules/lesson/index.php?view=add">Course Video/PDF</a></li> 
                                </ul>
                            </li> 
                            <li class="nav-user dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo web_root; ?>images/avatar.png" class="nav-avatar" />
                                <b class="caret"></b></a>
                                <ul class="dropdown-menu">
        ...
        <div class="wrapper">
                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="<?php echo web_root; ?>admin/modules/lesson/index.php"><i class="menu-icon icon-bullhorn"></i>Course</a>
                                </li>
                                <li><a href="<?php echo web_root; ?>admin/modules/exercises/index.php"><i class="menu-icon icon-inbox"></i>Assignments <b class="label green pull-right">
                                    11</b> </a></li> 
                            </ul>
                            <!--/.widget-nav-->
         ...
         <div class="footer">
            <div class="container">
                <h4><b class="copyright">&copy; 2021 Group 44 CCL Project </b>All rights reserved.</h4>
            </div>
        </div>
